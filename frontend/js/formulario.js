window.onload = async () => {
    ...
    try {
        ...
        const inputRelaseData=document.getElementById('release_date');
        inputRelaseData.setAttribute('value',data.release_date.split('T')[0])
